...
//		bind(INTERFACE);
		...
		gui.drawTexture(INTERFACE, adjustedWidth - 71, height - 80, 0, 160, 141, 10);
		gui.drawTexture(INTERFACE, adjustedWidth - 71, height - 80, 0, 150, (int) (141.0D * (color / 100.0D)), 10);
		RenderSystem.setShaderColor(1f, 1f, 1f, 1f);
