...
//			bind(WIDGETS_TEX_PATH);
			...
			gui.drawTexture(WIDGETS_TEX_PATH, posX, scaledHeight - 47 + posY, 0, 0, 182, 22);
			gui.drawTexture(WIDGETS_TEX_PATH, posX + entityplayer.getInventory().selectedSlot * 20, scaledHeight - 47 - 1 + posY, 0, 22, 24, 22);

			gui.drawTexture(WIDGETS_TEX_PATH, posX + 181, scaledHeight - 47 + posY, 60, 23, 22, 22);
			...
			this.renderHotbarItem(gui, posX + 184, l1, partialTicks, entityplayer, itemstack);
...
//                    bind(new Identifier("textures/gui/icons.png"));
					Identifier gui_icons = new Identifier("textures/gui/icons.png");
					int k1 = (int) (f1 * 19.0F);
					RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
					gui.drawTexture(gui_icons, j2, i2 - 9, 0, 94, 18, 18);
					gui.drawTexture(gui_icons, j2, i2 - 9 + 18 - k1, 18, 112 - k1, 18, k1);
				}
			}
