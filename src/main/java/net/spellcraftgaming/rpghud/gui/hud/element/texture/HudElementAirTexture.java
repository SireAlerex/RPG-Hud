...
//		bind(INTERFACE);
		...
		gui.drawTexture(INTERFACE, adjustedWidth - 70, height - 80, 0, 160, 141, 10);
		gui.drawTexture(INTERFACE, adjustedWidth - 70, height - 80, 0, 140, (int) (141.0D * (airAmount / maxAir)), 10);
		RenderSystem.setShaderColor(1f, 1f, 1f, 1f);
