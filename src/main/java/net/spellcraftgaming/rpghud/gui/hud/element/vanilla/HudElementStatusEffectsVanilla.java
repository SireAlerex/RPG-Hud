...
public class HudElementStatusEffectsVanilla extends HudElement {
    ...
    @Override
    public void drawElement(DrawContext gui, float na, float partialTicks, int scaledWidth, int scaledHeight) {
...
//                bind(HandledScreen.BACKGROUND_TEXTURE);
                if(effectinstance.shouldShowIcon()) {
                    ...
                    if(effectinstance.isAmbient()) {
                        // Background Beacon
                        gui.drawTexture(HandledScreen.BACKGROUND_TEXTURE, k, l, 165, 166, 24, 24);
                    } else {
                        // Background Regular
                        gui.drawTexture(HandledScreen.BACKGROUND_TEXTURE, k, l, 141, 166, 24, 24);
...
//                    bind(textureatlassprite.getAtlasId());
                    ...
                    gui.drawSprite(k + 3, l + 3, 0, 18, 18, textureatlassprite);
                    // Main
                    if(rpgHud.settings.getBoolValue(Settings.status_time) && !effectinstance.isAmbient()) {
                        ...
                        this.drawStringWithBackground(gui, s, k +12, l +14, -1, 0);
                    }
                }
            }
        }
